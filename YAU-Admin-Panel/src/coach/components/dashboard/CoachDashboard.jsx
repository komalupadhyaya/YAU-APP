...
import { MessageSquare, Users, Calendar, BookOpen, BarChart3, School, ClipboardList } from 'lucide-react';
import CoachPickup from '../pickup/CoachPickup';
import CoachAssignmentsView from '../assignments/CoachAssignmentsView';
...
const CoachDashboard = ({ onSwitchToMemberView }) => {
  ...
  const tabs = [
    ...
    { id: 'pickup', label: 'School Pickup', icon: School },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'pickup' && (
          <CoachPickup coachData={coachData} />
        )}
      </div>
    </div>
  );
