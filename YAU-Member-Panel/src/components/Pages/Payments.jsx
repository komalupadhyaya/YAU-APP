...
function Payments() {
  ...
  const testAPI = useCallback(async () => {
    ...
    try {
      const testUrl = `${process.env.NODE_ENV === 'development' ? 'https://us-central1-yau-app.cloudfunctions.net/apis' : 'https://yau-app.onrender.com'}/payments/history/email/${encodeURIComponent(user.email)}`;
